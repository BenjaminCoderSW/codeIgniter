...
class Peliculas extends Controller{
    ...
    public function guardar_pelicula()
    {
        ...
        if(!$validacion){
            ...
            $session = session();
            $session->setFlashdata("mensaje","Información inválida. El archivo debe ser una imágen tipo: -jpg -jpeg -png -webp y que esta no sea mayor a 1024píxeles");
    ...
    public function borrar_pelicula($id_pelicula=null){
        //hacemos el objeto de tipo pelicula
        $pelicula = new Pelicula();
        //buscamos la pelicula segun el id seleccionado
